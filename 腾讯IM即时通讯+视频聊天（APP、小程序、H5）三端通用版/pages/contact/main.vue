<template>
  <div class="container">
		<div class="rows"  @click="open('/pages/search/main?type=user')">发起会话</div>
		<div class="rows"  @click="open('/pages/search/main?type=user')">加入群聊</div>
		<div class="rows"  @click="open('/pages/create/main')">新建群聊</div>
		<div class="rows"  @click="open('//pages/blacklist/main')">我的黑名单</div>
		<div class="rows"  @click="open('/pages/groups/main')">我的群组</div>
